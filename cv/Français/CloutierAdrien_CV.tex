...
\cvitem{Depuis 2020}{\textbf{Université Laval}, Québec}
\cvitem{}{\textbf{Doctorant en science politique}, Directeur: \textit{Yannick Dufresne, Ph.D.}}
\vspace{1em}

\cvitem{2021}{\textbf{AFI Expertise Inc.}, Québec}
\cvitem{}{\textbf{Certification Scrum Master}}
\vspace{1em}

\cvitem{Depuis 2021}{\textbf{Université Laval et École supérieure d'études internationales (ESEI)}, Québec}
\cvitem{}{\textbf{École interdisciplinaire outils et méthodes (EIOM)}}
\cvitem{}{\textit{Rôle}: Co-créateur}
\vspace{1em}
...
\cvitem{}{\textbf{Diplôme du programme d’anglais pancanadien \textit{Explore}}}
\vspace{1em}
...
\cvitem{À venir}{Dufresne, Y., et \textbf{Adrien Cloutier}. \textit{Outils de recherche numériques}. Presse de l'Université Laval.}
\vspace{1em}
...
\cvitem{Depuis 2023}{\textbf{Chargé de cours}}
\cvitem{}{\textit{Méthodologie quantitative (POL-2000).}}
\vspace{1em}

\cvitem{Depuis 2023}{\textbf{Coordonnateur}}
\cvitem{}{\textit{Centre d'analyse des politiques publiques (CAPP).}}
\vspace{1em}

\cvitem{Depuis 2020}{\textbf{Coordonnateur}}
\cvitem{}{\textit{Chaire de leadership en enseignement des sciences sociales numériques (CLESSN).}}
\vspace{1em}

\cvitem{Depuis 2022}{\textbf{Scientifique de données}}
\cvitem{}{\textit{Musée de la civilisation de Québec.}}
\vspace{1em}

\cvitem{Depuis 2020}{\textbf{Auxiliaire d'enseignement}}
...
\cvitem{Depuis 2018}{\textbf{Journaliste-bénévole}}
\cvitem{}{\textit{Magazine de rue La Quête.}}
\vspace{1em}

\cvitem{2018}{\textbf{Recherchiste}}
\cvitem{}{\textit{Segma recherche.}}
\vspace{1em}

\cvitem{2018}{\textbf{Recherchiste}}
\cvitem{}{\textit{Boussole électorale 2018}, Voxpop Labs.}
\vspace{1em}

\cvitem{2015 -- 2017}{\textbf{Journaliste}}
\cvitem{}{\textit{Québec Hebdo}, Transcontinental Média.}
\vspace{1em}

\cvitem{2015}{\textbf{Stage rémunéré en journalisme}}
\cvitem{}{\textit{La Presse canadienne à l’Assemblée nationale du Québec.}}
\vspace{1em}
...
\cvitem{2023}{European Consortium for Political Research (ECPR). \textit{Weighting Pledge Fulfilment: A Measure Based on Pledge Salience.} Prague, République tchèque.}
\vspace{1em}

\cvitem{2023}{Conférence à l'Université Félix Houphouët-Boigny de Cocody. \textit{L'ère du numérique: entre défis et opportunités.} Abidjan, Côte d'Ivoire.}
\vspace{1em}
...
\cvitem{2022-2023}{École interdisciplinaire outils et méthodes (EIOM). \textit{Systématiser une revue de littérature} Université Laval, Québec.}
\vspace{1em}

\cvitem{2021}{Canadian Political Science Association (CPSA). \textit{Apples and Oranges? Comparing Canada's Sentiment about COVID-19 Using the French and the English Lexicoders}. Pannel Web}
\vspace{1em}

\cvitem{2020}{European Consortium for Political Research (ECPR). \textit{The Saliency of Election Pledges: Measurement Challenges.} Pannel Web} 
\vspace{1em}
...
% \section{\textbf{Contrats de recherche}}
% 
% \cventry{2020}{Centre d'analyse des politiques publiques (CAPP)}{Université Laval}{Québec}{Développement de l'outil RADAR+}
% {Chercheur étudiant avec les professeurs Yannick Dufresne et Lisa Burch.}
% \vspace{1em}
% 
% \cventry{Depuis 2019}{Chaire de leadership en enseignement des sciences sociales numérique (CLESSN)}{Université Laval}{Québec}{Recherche sur les perceptions des Québécoises et Québécois par rapport à l'alcool}
% {Chercheur étudiant pour l'Institut nationale de santé publique du Québec (INSPQ).}
% \vspace{1em}
% 
% \cventry{2019}{Département de science politique}{Université Laval}{Québec}{Recherche sur les techniques d’analyse de contenu par le crowdsourcing}
% {Chercheur étudiant avec les professeurs Yannick Dufresne et Mathieu Ouimet.}
% \vspace{1em}
% 
% \cventry{2018}{Département de science politique}{Université Laval}{Québec}{Étude de la portée de la littérature sur l’acceptabilité sociale de la drogue, du tabac et de l'alcool}
% {Chercheur étudiant avec le professeur Yannick Dufresne.}
% \vspace{1em}
% 
% \cventry{2018}{Département de science politique}{Université Laval}{Québec}{Construction d'un recueil de textes pour le cours Analyse quantitative (POL-7004)}
% {Chercheur étudiant pour le professeur Yannick Dufresne.}
% \vspace{1em}
% 
% \cventry{2016 -- 2018}{Département de science politique}{Université Laval}{Québec}{}
% {Auxiliaire de recherche pour la professeure Sule Tomkinson.}
% \vspace{1em}
...
\cventry{2020-2024}{Bourse au doctorat en recherche}{Fonds de recherche Société et culture (FRQSC)}{Université Laval}{}
{}
...
\cventry{2017}{Mention d’honneur du doyen}{Faculté des sciences sociales}{Université Laval}{}
{Récompense l'excellence des résultats académiques.}

% \cventry{2016}{Bourse du programme Explore}{Ministère de l'Enseignement supérieur}{Gouvernement du Québec}{Québec}
% {}
...
\cvitem{Programmes}{Langages \LaTeX, Markdown, Quarto, R, Git, Notion, Suite Adobe, Série Microsoft Office.}
\vspace{1em}

\cvitem{Spécialisation}{Méthode Agile (scrum master); Gestion d'équipes et de projets; Analyse des médias; Méthodes quantitatives; Analyse textuelle automatisée (Bag of Words, Topic Modeling, Dictionnaires, etc.)}
\vspace{1em}
